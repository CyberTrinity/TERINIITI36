...
//© 2022 Xeon Bot Inc. Trinity Bot MD
...
console.log(color('\n🐶 YT CHANNEL: ehannzzz ','silver'))
console.log(color('🐶 INSTAGRAM: ehannzzz ','silver'))
console.log(color('🐶 WA NUMBER: +6285759048584 ','silver'))
console.log(color('  🦄AzzBot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6289604314383'))
    console.log(color('🐶', 'cyan'), color('Trinity Bot Is Online...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using Trinity Bot', 'white'))
